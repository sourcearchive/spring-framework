 ...
 * is not necessary, as PortletModeHandlerMapping, ParameterHandlerMapping,
 * and PortletModeParameterHandlerMapping are included in the framework.
 * The first is the default if no HandlerMapping bean is registered in the 
 ...
 * The DispatcherPortlet will first call each HandlerInterceptor's preHandle
 * method in the given order, finally invoking the handler itself if all
 * preHandle methods have returned "true".
 *
 * <p>The ability to parameterize this mapping is a powerful and unusual
 * capability of this Portlet MVC framework. For example, it is possible to write
...
public interface HandlerMapping {
	 ...
	 * DispatcherPortlet will query all registered HandlerMapping beans to find
