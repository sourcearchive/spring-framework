...
/**
 * Extension of AopConfigException thrown when trying to perform an
 * advisor generation operation on a class that is not an
...
public class NotAnAtAspectException extends AopConfigException {
	...
	/**
	 * @return Returns the nonAspectClass.
	 */
	public Class<?> getNonAspectClass() {
		return nonAspectClass;
	}
